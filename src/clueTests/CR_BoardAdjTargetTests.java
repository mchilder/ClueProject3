...
public class CR_BoardAdjTargetTests {
	...
	{
		// Test a corner
		Set<Integer> testList = board.getAdjList(board.calcIndex(0, 0));
	...
	{
		// TEST DOORWAY RIGHT 
		Set<Integer> testList = board.getAdjList(board.calcIndex(11, 6));
	...
	public void testAdjacencyDoorways()
	{
		...
		Set<Integer> testList = board.getAdjList(board.calcIndex(4, 4));
	...
	public void testAdjacencyWalkways()
	{
		...
		Set<Integer> testList = board.getAdjList(board.calcIndex(0, 4));
